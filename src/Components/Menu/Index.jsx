...
const Index= () => {
    return (
        ...
        <div className='-z-20'>
            <p className='text-center md:mt-60 mt-2 md:text-5xl font-medium'>Nikonikoni Let's view Raffnime.id</p>
            <p className='text-center md:text-5xl font-medium'>My recomended you can See top recomendedlist</p>
